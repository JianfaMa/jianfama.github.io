    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "projects-airhunt",
          title: 'AirHunt',
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/airhunt/";
            },},{id: "projects-airsim-quadrotor-continuous-motion-controller",
          title: 'AirSim Quadrotor Continuous-Motion Controller',
          description: "Continuous-motion control and trajectory-tracking experiments for a quadrotor in Microsoft AirSim.",
          section: "Projects",handler: () => {
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/rogaussianocc/";
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%6D%61%6A%69%61%6E%66%61%32%30%30%34@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/Pluviophil3", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=hvxKXKYAAAAJ", "_blank");
        },
      },{
      id: 'light-theme',
